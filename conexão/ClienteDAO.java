...
public class ClienteDAO {
    ...
    public boolean alterarCliente(Cliente p){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"Erro ao alterar o número do cliente! " );
        }
        return ret;
    }
    ...
    public Cliente buscarClienteCPF(Cliente cli){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"CPF do cliente não foi encontrado! ");            
        }
        conex.fecharcon();
        return cli;
    }
    ...
    public boolean verificarSeJaExisteBD(String s){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"Erro ao executar a verificação da existência!" );
        }
        return false;
    }
